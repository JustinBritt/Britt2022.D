namespace Britt2022.D.Classes.Experiments
{
    ...
    public sealed class Experiment1 : IExperiment1
    {
        ...
        // Parameter: H(i)
        private ImmutableList<KeyValuePair<Organization, PositiveInt>> GenerateSurgeonMaximumNumberTimeBlocks(
            Bundle surgeons)
        {
            ImmutableList<KeyValuePair<Organization, PositiveInt>>.Builder builder = ImmutableList.CreateBuilder<KeyValuePair<Organization, PositiveInt>>();
        ...
        // Parameter: N(i)
        private ImmutableList<KeyValuePair<Organization, PositiveInt>> GenerateSurgeonStrategicTargets(
            Bundle surgeons)
        {
            ImmutableList<KeyValuePair<Organization, PositiveInt>>.Builder builder = ImmutableList.CreateBuilder<KeyValuePair<Organization, PositiveInt>>();
